...
| `Runtime/Plugins/Android/arm64-v8a/libZXing.so` | ZXing-C++、libzueci、Hoehrmann UTF-8 DFA、`libc++_static`、`libc++abi` | 同上；NDK r27c `27.2.12479018`、Clang `18.0.3`、LLVM `d8003a456d14a3deb8054cdaa529ffbf02d9b262` |
