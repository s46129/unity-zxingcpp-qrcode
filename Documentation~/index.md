...
See [Installation and native builds](installation.md), [performance measurements](performance.md), [third-party notices](../Third%20Party%20Notices.md), [acceptance specification](Spec/QRCodePackageSpec1.md), and import the Basic Gray8 Decode sample from Package Manager.
